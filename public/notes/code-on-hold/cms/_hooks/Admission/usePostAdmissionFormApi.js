...
const postStudent = async (trainingCourse, student) => {
  const studentUrl = `${process.env.NEXT_PUBLIC_API_KEY}/students`;
...
const postInstallments = async (studentId, trainingCourse, installments) => {
  const feeInstallmetUrl = `${process.env.NEXT_PUBLIC_API_KEY}/fee-Installments`;
...
const postAdmission = async (studentId, trainingCourse, admission = {}) => {
  const studentUrl = `${process.env.NEXT_PUBLIC_API_KEY}/admissions`;
