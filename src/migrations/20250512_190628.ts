...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE IF NOT EXISTS "attendance_rels" (
  ...
  ALTER TABLE "attendance" DROP CONSTRAINT "attendance_batch_id_batches_id_fk";
  ...
  ALTER TABLE "discount_codes" ALTER COLUMN "code" SET DEFAULT 'NEXUS-GLR9SQeqf3';
  ALTER TABLE "attendance" ALTER COLUMN "module_id" DROP NOT NULL;
  ALTER TABLE "attendance" ALTER COLUMN "date" SET DEFAULT '2025-05-12T19:06:24.445Z';
  ALTER TABLE "attendance" ALTER COLUMN "online_class_link" SET NOT NULL;
  ALTER TABLE "attendance" ADD COLUMN "expiry" timestamp(3) with time zone DEFAULT '2025-05-12T21:06:24.445Z';
  ALTER TABLE "attendance" ADD COLUMN "visible" boolean DEFAULT true;
  DO $$ BEGIN
  ...
  DO $$ BEGIN
   ALTER TABLE "attendance_rels" ADD CONSTRAINT "attendance_rels_batches_fk" FOREIGN KEY ("batches_id") REFERENCES "public"."batches"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "attendance_rels_order_idx" ON "attendance_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "attendance_rels_parent_idx" ON "attendance_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "attendance_rels_path_idx" ON "attendance_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "attendance_rels_batches_id_idx" ON "attendance_rels" USING btree ("batches_id");
  CREATE INDEX IF NOT EXISTS "attendance_rels_users_id_idx" ON "attendance_rels" USING btree ("users_id");
  ALTER TABLE "attendance" DROP COLUMN IF EXISTS "slug";
  ALTER TABLE "attendance" DROP COLUMN IF EXISTS "batch_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN IF EXISTS "class_links_id";
  ALTER TABLE "public"."attendance" ALTER COLUMN "type" SET DATA TYPE text;
  DROP TYPE "public"."enum_attendance_type";
  CREATE TYPE "public"."enum_attendance_type" AS ENUM('CLASS', 'LAB', 'MAKE-UP-CLASS', 'MAKE-UP-LAB');
  ALTER TABLE "public"."attendance" ALTER COLUMN "type" SET DATA TYPE "public"."enum_attendance_type" USING "type"::"public"."enum_attendance_type";`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE IF NOT EXISTS "class_links" (
  	...
  	"expiry" timestamp(3) with time zone DEFAULT '2025-05-10T13:06:49.837Z',
  ...
  ALTER TABLE "attendance" ALTER COLUMN "online_class_link" DROP NOT NULL;
  ALTER TABLE "attendance" ALTER COLUMN "module_id" SET NOT NULL;
  ALTER TABLE "attendance" ALTER COLUMN "date" SET DEFAULT '2025-05-10T11:06:49.837Z';
  ALTER TABLE "attendance" ADD COLUMN "slug" varchar NOT NULL;
  ALTER TABLE "attendance" ADD COLUMN "batch_id" integer NOT NULL;
  ...
  ALTER TABLE "attendance" DROP COLUMN IF EXISTS "expiry";
  ALTER TABLE "attendance" DROP COLUMN IF EXISTS "visible";
  ALTER TABLE "public"."attendance" ALTER COLUMN "type" SET DATA TYPE text;
  DROP TYPE "public"."enum_attendance_type";
