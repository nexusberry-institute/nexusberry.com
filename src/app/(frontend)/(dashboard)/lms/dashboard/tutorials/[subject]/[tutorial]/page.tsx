...
export async function generateMetadata({
  ...
  try {
    ...
    return { title: `${slug} | My Tutorials | NexusBerry LMS` }
  } catch {
    return { title: 'Tutorial | NexusBerry LMS' }
  }
}

export default async function LmsTutorialDetailPage({
  params: paramsPromise,
}: {
  params: Promise<{ subject: string; tutorial: string }>
}) {
  ...
  // Verify enrollment: tutorial's batches must overlap with student's batches
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center space-y-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Not Enrolled</h2>
          <p className="text-gray-500">
            You are not enrolled in a batch that includes this tutorial.
          </p>
          <Link
            href="/lms/dashboard/tutorials"
