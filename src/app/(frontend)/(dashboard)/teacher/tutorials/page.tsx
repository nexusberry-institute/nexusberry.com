...
export const metadata: Metadata = {
  title: 'Tutorials | Teacher Dashboard | NexusBerry',
}

export default async function TeacherTutorialsPage() {
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center space-y-4">
          ...
          <p className="text-gray-500">
            {!teacher
              ? 'Your teacher profile has not been set up yet. Please contact administration.'
              : 'You don\'t have any active batch assignments with tutorials yet.'}
          </p>
        </div>
      </div>
    )
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {subjectTutorials.map((tutorial) => {
                  ...
                  return (
                    <Link
                      key={tutorial.id}
                      href={`/teacher/tutorials/${subjectSlug}/${tutorialSlug}`}
