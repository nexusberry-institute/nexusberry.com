...
import { Mail, Lock, User, Phone, MapPin, BookOpen, ArrowRight, ArrowLeft } from 'lucide-react'
...
export const RegisterForm: React.FC = () => {
  ...
  const handleNextStep = async () => {
    ...
    const isValid = await form.trigger(['name', 'email', 'mobile', 'city', 'education', 'medium'])
    if (isValid) {
      setStep(2)
    }
  }
  ...
  return (
    <Card className="w-full max-w-md mx-auto rounded-xl bg-white/10 dark:bg-black/20 glassEffect shadow-[0_8px_32px_0_rgba(0,0,0,0.1)]">
      <CardHeader>
        ...
        <Progress value={step === 1 ? 50 : 100} className="h-1 mt-4" />
        <div className="flex justify-between text-xs mt-1">
          <span className={step === 1 ? "font-bold" : ""}>Personal Information</span>
          <span className={step === 2 ? "font-bold" : ""}>Account Security</span>
        </div>
      </CardHeader>
      <Form {...form}>
            ...
            {step === 1 ? (
              ...
              >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-2">
                      ...
                      <FormControl>
                        <div className="relative">
                          <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2" size={18} />
                          <Input
                            type="tel"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-2">
                      <FormLabel className='required'>Highest Education</FormLabel>
                      <FormControl>
                        <div className="relative">
                          <BookOpen className="absolute left-3 top-1/2 transform -translate-y-1/2" size={18} />
                          <Input
                            type="text"
                            placeholder="i.e.  B.Tech, M.Tech, B.Sc, M.Sc, BSCS etc."
                            className="pl-10 bg-white dark:bg-gray-900 rounded-md"
                            {...field}
                          />
                        </div>
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    type="submit"
                    className="flex-1 bg-black hover:bg-gray-800 text-gray-50 rounded-md"
                    disabled={form.formState.isSubmitting}
                  >
