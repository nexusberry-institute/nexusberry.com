...
export default async function UpcomingClasses({ slug }: { slug: string }) {
        ...
        <>
          <div className="mx-auto px-4 py-12 text-center">
            <div className="bg-card rounded-xl border border-primary p-8 max-w-md mx-auto">
              ...
              <h2 className="text-xl font-semibold mb-2">No Upcoming Masterclasses</h2>
              <p className="text-muted-foreground mb-6">
                We&#39;re currently planning new masterclasses. Check back soon or follow us on social media to stay updated about our upcoming events.
              </p>
