...
export async function GET(
  ...
  try {
    ...
    if (youtubeId) {
      return NextResponse.json({ d: encodeVideoPayload({ type: 'youtube', id: youtubeId }) }, { headers })
    }

    return NextResponse.json({ d: encodeVideoPayload({ type: 'external', id: video.videoUrl }) }, { headers })
  } catch {
